...
const Email: NextPage = () => {
  ...
  const finalSendEmail = async () => {
    setLoading(true);
    // Include the recipient email here
    const data = {
      email,
      message,
      name,
      recipient: "DevChetal@gmail.com"
    };
  ...
  return (
      <Scrollbars autoHide autoHideTimeout={1000} autoHideDuration={200} universal={true}>
        <Head>
          ...
          <meta name="description" content="Contact me for any discussions on cool ideas or projects or gaming." />
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2">
                      <div className="p-6 mr-2 mt-8 sm:rounded-lg">
                        ...
                        <p className="text-normal text-md font-normal text-gray-400 dark:text-gray-400 mt-2">
                          You can contact me with any questions, suggestions or just to say hi. I am always open to new ideas and collaborations.
                        </p>
                      ...
                      {!done ? (
                          <form className="p-6 flex flex-col justify-center">
                            ...
                            {!loading ? (
                                <button
                                    ...
                                    className="md:w-32 bg-indigo-600 hover:bg-blue-dark text-white font-bold py-3 px-6 rounded-lg mt-3 transition ease-in-out duration-300"
                                >
                                  Submit
                                </button>
                            ) : (
                                <div className="spinner-border flex pt-4 text-indigo-500" role="status">
                                  <Image
                          ...
                          <div className="flex w-4/3 items-center justify-center p-2 pt-5 pb-20">
                            <div className="text-center text-gray-300 font-medium text-sm">
                              <div className="text-left text-lg pb-3">
                                Thank you for your message. <br /> Will get back to you as soon as possible.
                              </div>
